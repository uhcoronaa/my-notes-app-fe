...
import * as notesSelectors from '../../notes/state/notes.selectors';
...
export class SortNotesComponent implements OnInit, OnDestroy {
  ...
  constructor(private notesService: NotesService, private store: Store<AppState>, private toastService: ToastService) { }

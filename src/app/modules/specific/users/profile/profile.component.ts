...
export class ProfileComponent implements OnInit, OnDestroy {
  ...
  constructor(private fb: FormBuilder, private store: Store<AppState>, private userService: UsersService, private router: Router, private toastService: ToastService) { }
